...
pode afirmar automaticamente a respeito de sua boa formação. Este trabalho levanta
métodos de avaliação aplicáveis ao português brasileiro analisando: léxicos, gramáticas de
...
intercambiáveis nem ordenáveis por qualidade: suas coberturas são complementares. 
Dos métodos são selecionados os com melhores resultados e compõe-se uma \emph{pipeline} 
de quatro etapas, cuja ordem decorre das propriedades medidas e 
cujo veredito resulta da vacuidade de um conjunto de achados
